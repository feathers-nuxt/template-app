...
module.exports =  
  ...
  surname: type: _.STRING, allowNull: false, validate: {}
  otherNames: type: _.STRING, allowNull: false, validate: {}
  phone: type: _.STRING, allowNull: false, validate: {}
  email: type: _.STRING, allowNull: false, validate: {}
  createdAt: _.DATE
  updatedAt: _.DATE